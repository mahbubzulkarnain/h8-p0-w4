...
function changeMe(arr) {
    // you can only write your code here!
    if(!!!arr || typeof arr[0] != 'object' || typeof arr[0][0] != 'string' || typeof arr[0][1] != 'string' || typeof arr[0][2] != 'string') {
        console.log('')
        return false
    }
    ...
    for(let i=0;i<arr.length;i++){
        let getAge = (!!arr[i][3] && (year - arr[i][3]) < year  ? (year - arr[i][3]) : 'Invalid Birth Year')
